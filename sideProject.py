    ...
    for row in range(chess_grid_row):
        for col in range(chess_grid_col):
            ...
            if temp_chess_list[row][col] != 0:
                not_null_sum = temp_chess_list[row][col]
...
def AI(chess_list,type):
    ...
    if chess_list[5][0]==0:
        chess_list[5][0]=type
        return 0
    if chess_list[4][3]==0 and chess_list[5][3]==2:
        chess_list[4][3]=1
        return 0
    if chess_list[4][2]==0 and chess_list[5][2]==2:
        chess_list[4][2]=1
        return 0
    if chess_list[4][1]==0 and chess_list[5][1]==2:
        chess_list[4][1]=1
        return 0
    if chess_list[4][5]==0 and chess_list[5][5]==2:
        chess_list[4][5]=1
        return 0
